...
library Limiters {
    ...
    uint256 public constant MAX_COOLDOWN_BLOCKS = 1 days / 12 seconds;
    ...
    struct LinearGrowthLimiter {
        uint256 maximum;
        /// The maximum limit of the function.
        uint256 rate;
        /// The rate at which the function increases back to its maximum.
        uint256 lastValue;
        /// The most recently saved value of the function.
        uint256 lastBlock;
        /// The block that `lastValue` was recorded.
        uint256 minLimit;
    }
    /// A minimum limit to avoid malicious governance bricking the contract
    ...
    function createLinearGrowthLimiter(
        ...
        internal
        view
        returns (LinearGrowthLimiter memory)
    {
